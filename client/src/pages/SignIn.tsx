    ...
    <div className="min-h-screen flex items-center justify-center px-4 w-full app-bg text-white">
      <div className="w-full max-w-md space-y-6">
        <Card className="w-full bg-[#111827] border border-white/10 p-8 shadow-[0_20px_70px_rgba(0,0,0,0.35)]">
          ...
          <p className="text-[#A6B0BE] mb-6">{copy.auth.signInSubtitle}</p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder={copy.auth.yourUsername}
            ...
            >
              {signInMutation.isPending ? copy.auth.signingIn : copy.home.signIn}
            </Button>
            <button
